...
$esxiHosts = Get-VMHost | Select-Object Name, ConnectionState, @{Name="InMaintenanceMode";Expression={$_.ConnectionState -eq "Maintenance"}}
...
$worksheetName = "MaintMode"

# Export the results to an Excel file
$esxiHosts | Export-Excel -Path $excelPath -WorksheetName $worksheetName -AutoSize -TableName "MaintMode"
