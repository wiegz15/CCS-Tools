...
# $progressData = Show-ProgressForm -title "Checking Modules" -message "Checking ImportExcel module..."

# if (-not $importExcelModule) {
#     Update-ProgressBar -progressData $progressData -text "ImportExcel module not installed..." -percent 30
...
#         Update-ProgressBar -progressData $progressData -text "Installing ImportExcel..." -percent 50
#         try {
#             Install-Module -Name ImportExcel -Scope CurrentUser -Force
#             Import-Module ImportExcel
#             [System.Windows.Forms.MessageBox]::Show("ImportExcel module installed successfully.", "Installation Successful")
#             Update-ProgressBar -progressData $progressData -text "ImportExcel installed..." -percent 100
#         } catch {
...
# } else {
#     Import-Module ImportExcel
#     Update-ProgressBar -progressData $progressData -text "ImportExcel module found..." -percent 100
# }

# # Close the progress form after a delay
...
# $progressData = Show-ProgressForm -title "Checking VMware PowerCLI" -message "Checking VMware PowerCLI module..."

# if (-not $powerCLIModule) {
#     Update-ProgressBar -progressData $progressData -text "VMware PowerCLI not installed..." -percent 20
...
#         Update-ProgressBar -progressData $progressData -text "Installing VMware PowerCLI..." -percent 40
#         try {
...
#             Update-ProgressBar -progressData $progressData -text "VMware PowerCLI installed..." -percent 100
#         } catch {
...
#     Update-ProgressBar -progressData $progressData -text "Older version of PowerCLI found..." -percent 50
...
#             Update-ProgressBar -progressData $progressData -text "VMware PowerCLI updated..." -percent 100
#         } catch {
...
# } else {
#     Import-Module VMware.PowerCLI
#     Update-ProgressBar -progressData $progressData -text "Latest VMware PowerCLI already installed..." -percent 100
# }
